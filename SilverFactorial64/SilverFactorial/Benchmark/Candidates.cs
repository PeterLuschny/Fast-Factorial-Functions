...
namespace SilverFactorial
{
    ...
    {                             
        ...
        new Candidate(new Sharith.Math.Factorial.ParallelPrimeSwing(), "ParaSplitPrimeSwing",  0, true, true, true, false,true,1), 
        ...
        new Candidate(new Sharith.Math.Factorial.Split(),              "Split              ", 13, true,false,false,true, false,11), 
        ...
        new Candidate(new Sharith.Math.Factorial.MyFactorial(),        "MyFactorial        ", 22, false,false,false,false,false,20) 
    };
