...
namespace Sharith.Math.Factorial 
{
    ...
    public class ParallelPrimeSwingList : IFactorialFunction 
    {
        public ParallelPrimeSwingList() { }
        ...
        public string Name
        {
            get { return "ParallelPrimeSwingList"; }
        }
        ...
        public XInt Factorial(int n)
        {
            ...
            Parallel.For(1, log2n, i =>
                results[i] = XMath.Product(primeList[i], 0, listLength[i])
            );
...
}  // endOfFactorialParallelPrimeSwingList
